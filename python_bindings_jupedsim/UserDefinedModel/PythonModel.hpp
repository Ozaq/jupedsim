...
#include "OperationalModels/UserDefinedModel/UserDefinedModel.hpp"
#include "OperationalModels/UserDefinedModel/UserDefinedModelData.hpp"
#include "OperationalModels/UserDefinedModel/UserDefinedModelUpdate.hpp"
#include "SimulationError.hpp"
#include "UserDefinedModel/PythonModelData.hpp"
#include "UserDefinedModel/PythonModelUpdate.hpp"
...
class PythonModel : public UserDefinedModel
{
    using UserDefinedModel::UserDefinedModel;

public:
    void ApplyUpdate(const OperationalModelUpdate& update, GenericAgent& agent) const override
    {
        const auto& upd = std::get<UserDefinedModelUpdate>(update).Get<PythonModelData>();
        auto& model = std::get<UserDefinedModelData>(agent.model).Get<PythonModelUpdate>();
